...
<html>
    <head>
        <title>Costo de Importaciones Recibidas de U-100</title>
        <meta charset="UTF-8">
        ...
        <script type="text/javascript" src="js/functionsCostoU100.js"></script>
    </head>
    <body>
        ...
        <div id="cuerpo">
            ...
            <div class="title">
                COSTO DE IMPORTACIONES RECIBIDAS DE U-100<br/>
