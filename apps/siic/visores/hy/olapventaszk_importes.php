...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/fventaszk_olap_importes.js"></script>
        <style>
    ...
    <body>
        ...
        <header>
            <div id='leftHeader'>
                ...
                <span id="appName" >Ventas ZarKruse Importes sin IVA ni descuentos financieros</span>
            </div>
            <div id='rightHeader'>
