...
function creaQueries() {
    ...
    $query = "select pedimento,Nivel,Fecha from FSegPedimentoIMP where Nivel<>'' and Fecha BETWEEN '$fec1' AND '$fec2'";
...
function tipo($mysqli) {
    ...
    $respuesta["currencyCols"] = array(2,3);
    $respuesta["sumCol"] = 2;
...
function provTipoNivel($mysqli) {
    ...
    $respuesta["currencyCols"] = array(4,5);
    $respuesta["sumCol"] = 4;
...
function tipoNivel($mysqli) {
    ...
    $respuesta["currencyCols"] = array(3, 4);
    $respuesta["sumCol"] = 3;
