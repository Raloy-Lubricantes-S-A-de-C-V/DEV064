<?php
	...
	header("Content-Disposition: filename=Reporte_General.xls");
...
<body>
 <table id="datos" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp siic-tabla__padding">
                                ...
                                <tr>
                                    ...
                                    <th class="mdl-data-table__cell--non-numeric">prod_std</th>
                                </tr>
