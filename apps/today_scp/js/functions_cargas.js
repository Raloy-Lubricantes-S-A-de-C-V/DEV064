...
$(document).ready(function() {
    $('#modal-recepcion-raloy').on('show.bs.modal', function(event) {
        $("#input-num-recepcion").val("")
        datosRecepcionRaloy(function() {
            $("#btn-save-recepcion").removeAttr("disabled")
            $("#btn-save-recepcion")
                .off("click")
                .on("click", function() {
                    voboAMP()
