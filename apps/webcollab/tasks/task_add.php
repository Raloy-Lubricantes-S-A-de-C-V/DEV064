...
if (@safe_integer($_GET['parentid'])) {
    ...
    $content .= "</select></td></tr>" .
            "<tr><td></td><td><div id='precedentstoadd' name='precedentstoadd' style='padding:5px;border:solid 1px rgb(195, 195, 195);'></div></td></tr>";
    //End of precedents
    
    $content .= "<tr><td>" . $lang['deadline'] . ":</td><td>" . date_select($parent_row['deadline']) .
