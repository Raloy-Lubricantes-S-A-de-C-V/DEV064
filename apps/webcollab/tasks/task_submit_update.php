...
function find_children($parent, $new_parentid) {
    ...
    for ($i = 0; $i < $task_count; ++$i) {
        ...
        if ($new_parentid == $task_array[$i]['id'])
            return true;
...
db_execute($q, array($name, $text, $owner, $deadline, $priority, $taskgroupid, $usergroupid, $status, $globalaccess, $groupaccess, $strprecedentids, $taskid));
